...
static void new_GPIO_Config(void); //Config For PA1
...
/*Config GPIO Interrupt in Register Level*/
void new_GPIO_Config(void)
{
   ...
   /*Set Up GPIO External Interrupt for PA1 !!*/
   RCC->APB2ENR |= RCC_APB2ENR_AFIOEN;

   // Configure EXTI1 to use PA1 as the interrupt source
   AFIO->EXTICR[0] &= ~(AFIO_EXTICR1_EXTI1);
   AFIO->EXTICR[0] |= AFIO_EXTICR1_EXTI1_PA;

   //Config in Rising or Falling Edge
